...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to={"/"}><img src={assets.logo} className='w-25'/></Link>
        ...
        <div className='flex items-center gap-6'>
            <img onClick={()=>(showSearch ? setShowSearch(false): setShowSearch(true))} src={assets.search_icon} className='w-5 cursor-pointer'/>
